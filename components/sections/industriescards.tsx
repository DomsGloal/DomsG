      ...
      <div className="container-custom px-6 md:px-16">
        ...
        >
          {industries.map((industry, index) => (
            <motion.div
              key={index}
              className="bg-white dark:bg-card border border-gray-200 dark:border-gray-700 shadow-md rounded-2xl p-6 relative group transition-colors"
              variants={cardVariants}
              whileHover="hover"
            >
              <p className="text-sm text-gray-400 dark:text-gray-500 mb-2">Industry</p>
              <h3 className="text-lg font-semibold text-gray-800 dark:text-white">{industry}</h3>
              <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Explore services</p>
